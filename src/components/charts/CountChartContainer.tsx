...
const CountChartContainer = async () => {
  ...
  //prisma.groupBy() to group records by field values, [{sex: 'FEMALE', _count:25},{sex: 'MALE', _count:25}]
  const data = await prisma.student.groupBy({ by: ["sex"], _count: true });
  //we use find() function to loop through data array & get boys/girls count, then pass them to the Chart
