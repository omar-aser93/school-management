//Skeleton Loading for List pages .. in next, it works automaticlly when you name a file loading.tsx 
  ...
  return (
    <div className="p-8 animate-pulse">
      <div className=" rounded-lg overflow-hidden shadow-md">
        ...
        <div className="p-4">
          {[...Array(10)].map((_, index) => ( <div key={index} className="flex items-center justify-between mb-4 py-2 mt-4" >
